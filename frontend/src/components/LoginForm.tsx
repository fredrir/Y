...
const LoginForm = () => {
  ...
  return (
    <div className="flex flex-grow w-full flex-col items-center self-center min-h-screen">
      <h1 className="w-fit mt-32 bg-gradient-to-r from-indigo-950 to-indigo-700 bg-clip-text text-4xl font-extrabold text-transparent dark:from-indigo-200 dark:to-indigo-500 sm:text-6xl md:text-7xl top-4">
        Welcome to Y
      </h1>
        <div className="flex flex-grow justify-center items-center">
          <div className="w-96 rounded-lg bg-gray-50 p-8 shadow-md dark:bg-gray-900 h-fit">
