...
const LoginForm = ({ view }: LoginFormProps) => {
  ...
  return (
    <div className="flex flex-grow w-full flex-col items-center self-center min-h-screen">
      <h1 className=" mt-32 w-fit bg-gradient-to-r from-indigo-950 to-indigo-700 bg-clip-text text-4xl font-extrabold text-transparent dark:from-indigo-200 dark:to-indigo-500 sm:text-6xl md:text-7xl">
        Welcome to Y
      </h1>
